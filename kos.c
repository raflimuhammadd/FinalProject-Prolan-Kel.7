...
int main(){
    ...
    if(pilih == 1){
        ...
        if(pilih == 1){
			...
			printf("\t\t\t\t |----------- J U R A G A N  K O S T -----------|\n");
			printf("\t\t\t\t +==============================================+\n");
			printf("\t\t\t\t |           PILIH BERDASARKAN URUTAN           |\n");
			printf("\t\t\t\t +----------------------------------------------+\n");
            printf("\t\t\t\t | [1] Urutan berdasarkan Tipe                  |\n");
            printf("\t\t\t\t | [2] Urutan berdasarkan Alamat                |\n");
            printf("\t\t\t\t | [3] Urutan berdasarkan Jumlah Penghuni Kamar |\n");
            printf("\t\t\t\t | [4] Urutan berdasarkan Harga                 |\n");
            printf("\t\t\t\t | [0] Exit                                     |\n");
			printf("\t\t\t\t +==============================================+\n");
            printf("\t\t\t\t ==> MASUKKAN PILIHAN ANDA : ");
            scanf("%d", &pilih);
    	...
    	switch(getch()){
            ...
            close();
            break;
            default:printf("\n\t\t\t\t | Maaf, terjadi Kesalahan pada Inputan!");
            getche();
            goto erase_valid;
        }
	}
...
void input_pemilik(){
	...
	while (fscanf(fptr1,"%d %d %[^;]; %d %lf",&kst.id,&kst.tipe,kst.alamat,&kst.jum_penghuni,&kst.harga)!=EOF)
	{
		...
		printf("\t\t\t\t +----------------------------------------------+\n");
		printf("\t\t\t\t | Masukan Tipe kos\t\t: ");fflush(stdin);
		scanf("%d", &kst.tipe);
...
void update_kos(){
	...
	printf("\t\t\t\t |                  UPDATE DATA                 |\n");
	printf("\t\t\t\t +----------------------------------------------+\n");
	printf ("\n\t\t\t\t | Masukan ID kos yang ingin Diubah : ");
	scanf ("%d",&cek.id);
	...
	count++;
		...
		while(i <= count){
			...
			printf("\t\t\t\t |----------- J U R A G A N  K O S T -----------|\n");
			printf("\t\t\t\t +==============================================+\n");
			printf("\t\t\t\t | kos DENGAN ID : %d AKAN DIUPDATE!            |\n", update[i].id);
			printf("\n\t\t\t\t | Data yang akan digati : ");
	  ...
	  rename("JURAGANBARU.txt","JURAGANKOS.txt");
		if(test!=1){
			system("cls");
		printf("\n\t\t\t\t | Maaf, Data tidak ditemukan !\a\a\a");
			edit_invalid:
...
void sortharga(){
	    ...
	    int count=0,i,j,test=0,pilih;
	  	system("cls");
	    hargaa=fopen("JURAGANKOS.txt","r");
	  	while(fscanf(hargaa,"%d %d %[^;]; %d %lf",&kst.id, &kst.tipe, kst.alamat, &kst.jum_penghuni ,&kst.harga)!=EOF) {
	sorts[count].tipe = kst.tipe;
	sorts[count].jum_penghuni = kst.jum_penghuni;
	sorts[count].id = kst.id;
	sorts[count].harga = kst.harga;
		...
		switch(getch()){
      	...
      	erase_valid:
          	...
          	switch(getch())
            {
				...
				break;
				default:
				printf("\n\t\t\t\t | Maaf, terjadi Kesalahan pada Input !");
        	    getche();
      			goto erase_valid;
    	}
  	}
...
void cari_tipe(){
	...
	printf("\t\t\t\t +----------------------------------------------+\n");
	printf("\t\t\t\t ==> Masukkan Tipe yang Dicari : ");
	scanf("%d", &caritipe);
	for(i = 0; i < count; i++){
	...
	if(flag == 1){
  	...
  	{
    printf("\t\t\t\t | Data Tipe tidak ditemukan");
  	}
	resetMemory();
...
void cari_alamat(){
		...
		printf("\t\t\t\t |               PENCARIAN DATA                 |\n");
		printf("\t\t\t\t +----------------------------------------------+\n");
		printf("\t\t\t\t ==> Masukkan Alamat yang Dicari : ");
		gets(carialamat);
		...
		if(flag == 1){
			...
			printf("\t\t\t\t | Data Alamat kos tidak ditemukan");
		}
...
void cari_harga(){
	system("cls");
	    ...
	    printf("\t\t\t\t |                PENCARIAN DATA                |\n");
	    printf("\t\t\t\t +----------------------------------------------+\n");
		printf("\t\t\t\t | Masukkan Harga yang Dicari : ");
		scanf("%lf", &cariharga);
		printf("\n\t\t\t\t | %s\t%s\t%s\t%s\t%s \n\n", "ID","Tipe", "Alamat", "J.kamar", "Harga");
...
void sewa_kos(){
	...
	while(fscanf(lama,"%d %d %[^;]; %d %lf",&kst.id, &kst.tipe, kst.alamat, &kst.jum_penghuni , &kst.harga)!=EOF){
		if(kst.id != hapus.id){
			...
			printf("\t\t\t\t | kos Telah Berhasil Disewa!");
			}
		else
		{
			test++;
